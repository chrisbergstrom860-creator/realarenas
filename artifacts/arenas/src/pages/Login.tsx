...
export default function Login() {
  ...
  function goToFeed() { setLocation("/community"); }
        ...
        <div className="auth-form-wrap">
          ...
          {success ? (
            <div className="auth-success">
              ...
              <h3>You're in!</h3>
              <p>Welcome to Arenas. Your account is ready — let's take you to your personalised feed.</p>
              <button className="btn btn-yellow btn-full ld-btn-lg" onClick={goToFeed} data-testid="btn-go-to-feed">Go to my feed →</button>
            </div>
          ) : (
            <>
                    ...
                    <div className="onboard-step active" data-testid="signup-step-1">
                      ...
                      <form onSubmit={e => { e.preventDefault(); setStep(2); }} data-testid="form-signup-step1">
                        <div className="form-row">
                          <div className="form-field"><label className="form-label">First name</label><input type="text" className="form-input" placeholder="Jamie" value={firstName} onChange={e => setFirstName(e.target.value)} required/></div>
                  ...
                  {step === 3 && (
                    <div className="onboard-step active" data-testid="signup-step-3">
                      ...
                      <div style={{ display: "flex", gap: 8, marginTop: 8 }}>
                        ...
                        <button type="button" className="btn btn-primary" style={{ flex: 2 }} onClick={doSignup} disabled={loading} data-testid="btn-signup-finish">{loading ? "Creating account…" : "Finish setup →"}</button>
                      </div>
