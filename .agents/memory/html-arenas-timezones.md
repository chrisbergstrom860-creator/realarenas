...
- Rolling INSTANT windows are policy-exempt by design — `getDateRange` 7/30-day, at-risk/nudge 5-day, member-home weekly points, daysLeft/expectedPct countdowns: no day bucketing, leave as instant math.
